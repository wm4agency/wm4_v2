<!-- HOME MAIN SECTION CONTENTS -->
<main class="fullwidth">
    <div class="span-3 monolito-wrapper animated fadeInLeft"><?php include 'monolito_izq.php'; ?></div>
    <div class="span-6">
        <div class="row">
        ...
        <article id="cycle" class="row">
            ...
            <ul>
                ...
                <li>Marketing por objetivos</li>
                <li>Marketing con resultados</li>
                <li>Analíticos y optimización</li>
                <li>Publicidad con ROI medido</li>
            </ul>
        </article>
    </div>
