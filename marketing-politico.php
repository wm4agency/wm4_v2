...
<main class="<?php echo $role; ?> container row">
    <h1 class="span-12">marketing <br> Político</h1>
    <p role="definition" class="span-5">Construimos y desarrollamos una presencia pública estructurada que el público puede reconocer y valorar, con las que puede relacionarse positivamente. Operamos canales y medios digitales para construir reputación con sentido público. </p>
